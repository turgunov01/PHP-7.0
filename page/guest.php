        ...
        <main class="main">
            ...
            <?if(!$_SESSION['login']):?>
            <?else:?>
               <form action="./components/write-comment.php" class="form" method="post">
                        <label class="form__label" style="pointer-events: none">
                            <input type="text" class="form__input" name="name" value="<?=$_SESSION['name']?>">
                        </label>
                        <label class="form__label">
                            <span class="form__text">Оставте отзыв</span>
                            <textarea class="form__input" name="descr"></textarea>
                        </label>
                        <button class="form__btn" href="../components/write-comment.php">Отправить</button>
                    </form>
            <?endif;?>
            <div class="comments">
